...
insert into Pessoa values('Zé Barbosa e Marta Miranda');
...
insert into Professor values ('Zé Barbosa e Marta Miranda', 'Cabo Verde e Portugal', 'Kizomba');
...
insert into aula values('Amoreiras Plaza', 'Zé Barbosa e Marta Miranda', 'quinta', 'Kizomba', 30, 'intermedio');
insert into aula values('Jazzy', 'Petchu', 'segunda', 'Kizomba', 30, 'avançado');
...
insert into constituido values('Zé Barbosa e Marta Miranda', 'Afrofever');
